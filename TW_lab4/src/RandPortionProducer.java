...
public class RandPortionProducer extends Thread {
    private String name;
    ...
    public RandPortionProducer(String name, int portionNumberToProduce, int m,PCBuffer buffer) {
        this.name = name;
        ...
        for(int i = 0; i< portions.length;i++){
            ...
            for(int j  =0;j<1;j++) {
                try {
                    ...
                    buffer.put(currentPortionSize);
                    long end = System.nanoTime();
                    timeBuff.add("fair" + ";" + "put" + ";" + M + ";" + currentPortionSize + ";" + (end - begin) + ";" + "1000P/1000K" + "\r\n");

                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                //System.out.println("Thread: " +name+" no."+ Thread.currentThread().getId() + " puts: "+currentPortionSize+" elements;");
